...
# ----------------------------------------
# ACDS 17.1 590 win32 2022.05.10.21:52:10
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L altera_common_sv_packages -L error_adapter_0 -L border -L rsp_mux -L rsp_demux -L cmd_mux -L cmd_demux -L router_002 -L router -L ARM_A9_HPS_f2h_axi_slave_wr_cmd_width_adapter -L cmd_demux_001 -L ARM_A9_HPS_f2h_axi_slave_agent -L dma_1_read_master_agent -L dma_1_read_master_translator -L avalon_st_adapter -L dma_1_control_port_slave_burst_adapter -L ARM_A9_HPS_h2f_lw_axi_master_wr_limiter -L dma_1_control_port_slave_agent_rsp_fifo -L dma_1_control_port_slave_agent -L ARM_A9_HPS_h2f_lw_axi_master_agent -L dma_1_control_port_slave_translator -L reset_from_locked -L sys_pll -L hps_io -L fpga_interfaces -L rst_controller -L irq_mapper -L mm_interconnect_2 -L mm_interconnect_1 -L mm_interconnect_0 -L dma_2 -L dma_1 -L System_PLL -L Onchip_SRAM -L ARM_A9_HPS -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L altera_common_sv_packages -L error_adapter_0 -L border -L rsp_mux -L rsp_demux -L cmd_mux -L cmd_demux -L router_002 -L router -L ARM_A9_HPS_f2h_axi_slave_wr_cmd_width_adapter -L cmd_demux_001 -L ARM_A9_HPS_f2h_axi_slave_agent -L dma_1_read_master_agent -L dma_1_read_master_translator -L avalon_st_adapter -L dma_1_control_port_slave_burst_adapter -L ARM_A9_HPS_h2f_lw_axi_master_wr_limiter -L dma_1_control_port_slave_agent_rsp_fifo -L dma_1_control_port_slave_agent -L ARM_A9_HPS_h2f_lw_axi_master_agent -L dma_1_control_port_slave_translator -L reset_from_locked -L sys_pll -L hps_io -L fpga_interfaces -L rst_controller -L irq_mapper -L mm_interconnect_2 -L mm_interconnect_1 -L mm_interconnect_0 -L dma_2 -L dma_1 -L System_PLL -L Onchip_SRAM -L ARM_A9_HPS -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
